...
ggplot(centro_america, aes(x=reorder(name_long, -lifeExp), y=lifeExp)) +
  ggtitle("Esperanza de vida Centroamerica") +
  xlab("Paises") + 
...
```{r}
plot(centro_america["lifeExp"], main="Esperanza de vida-Centroamerica")
```
...
```{r}
centroamerica_abstracto <- centro_america[centro_america$lifeExp>=74,]
plot(centroamerica_abstracto["lifeExp"], main=" Centroamerica, paises con una esperanza de vida mayor o igual a los 74 años de edad ")
